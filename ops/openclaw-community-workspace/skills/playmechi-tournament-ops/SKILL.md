...
Use this for public community questions and announcement-safe replies about PlayMechi tournaments. This copy is for fixed facts only. Live counts, reward eligibility, disqualifications, payouts, payment confirmations, and admin decisions must route to `control`.
