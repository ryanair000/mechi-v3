...
export const WEEKEND_CUP_GAMES: OnlineTournamentGameConfig[] = [
  {
    ...
    mapsLabel: 'Rondo, Erangel, and Miramar',
    matchCount: '3 matches',
    scoring: 'Three-map series: Match 1 Rondo, Match 2 Erangel, Match 3 Miramar. 1 kill = 1 point. Placement points apply on the moderator desk.',
  ...
  },
  {
    ...
    mapsLabel: 'Isolated',
    matchCount: '3 matches',
    scoring: 'All 3 matches are played on Isolated. 1 kill = 3 points. Placement matters too.',
    firstPrize: 'KSh 1,250',
    secondPrize: 'KSh 1,000',
    thirdPrize: 'KSh 500',
    fourthPrize: '80 CP',
  ...
  },
  {
    ...
    mapsLabel: 'Online friendly 1v1 room',
    matchCount: 'Round of 32 to final',
    scoring: 'One leg per fixture from Round of 32. If it is level, settle it clean in extra time or pens. Bronze match determines 3rd and 4th place.',
  ...
  },
  {
    ...
    lateSlots: 20,
    format: 'Solo battle royale room',
    mapsLabel: 'Bermuda and Solara',
    matchCount: '3 matches',
    scoring: 'Three-map series: Match 1 Bermuda, Match 2 Bermuda, Match 3 Solara. 1 kill = 1 point. Placement points apply on the moderator desk.',
    firstPrize: 'KSh 1,250',
    secondPrize: 'KSh 750',
    thirdPrize: 'KSh 500',
