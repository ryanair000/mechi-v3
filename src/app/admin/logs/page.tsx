...
const ACTION_META: Record<string, { label: string; className: string }> = {
  ...
  review_tournament: { label: 'Review tournament', className: 'text-amber-400' },
  feature_tournament: { label: 'Feature tournament', className: 'text-[var(--brand-teal)]' },
  unfeature_tournament: { label: 'Remove featured tournament', className: 'text-[var(--text-secondary)]' },
  update_tournament_details: { label: 'Edit tournament details', className: 'text-[#60A5FA]' },
