...
description: "Community-safe static FAQ and announcement context for the Mechi.club Online Gaming Tournament."
metadata:
  owner: mechi
  workspace: community
---

# PlayMechi Tournament Community FAQ

Use this for public community questions and announcement-safe replies about the Mechi.club Online Gaming Tournament. This copy is for fixed facts only. Live counts, reward eligibility, disqualifications, payouts, and admin decisions must route to `control`.
...
- Keep replies short, hype, and clear.
- Do not promise payouts, eligibility, disqualification outcomes, or admin decisions.
- Route account-specific, dispute, payout, or live slot-count questions to `control` or `support`.
