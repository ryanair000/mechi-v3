...
5. The app sends through the Amazon SES v2 API via the AWS SDK. Do not run a separate SMTP relay for app mail.
...
AWS_SES_ENDPOINT_URL=https://email.us-east-2.amazonaws.com
...
- `AWS_SES_FROM_EMAIL` is the sender setting; remove any old generic sender variable from production.
