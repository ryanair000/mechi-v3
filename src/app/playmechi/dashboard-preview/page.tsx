...
const demoData: PlayerDashboardData = {
  ...
  incoming_challenges: [],
  teams: [],
  next_action: { kind: 'tournament', eyebrow: 'Next up', title: 'Your tournament starts soon', description: 'Open the event page and check your start time.', href: '/t/playmechi-community-cup', label: 'View tournament' },
  matches: [
  ...
  tournaments: [
    { id: 'registration-1', check_in_status: 'registered', tournament: { id: 'cup-1', slug: 'playmechi-community-cup', title: 'PlayMechi Community Cup', game: 'efootball', status: 'open', size: 16, scheduled_for: '2026-07-20T17:00:00Z' } },
    { id: 'registration-2', check_in_status: 'checked_in', tournament: { id: 'cup-2', slug: 'friday-fc-showdown', title: 'Friday FC Showdown', game: 'fc26', status: 'active', size: 8, scheduled_for: '2026-07-18T18:30:00Z' } },
  ],
  recommended: [
