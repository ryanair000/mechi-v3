...
export const V5_SCREEN_CATALOG: V5ScreenDefinition[] = [
  ...
  screen({
    ...
    active: 'Account',
    eyebrow: 'Account',
    title: 'One identity. The right workspace.',
    description:
      'Switch between personal, team, organizer, sponsor, creator, coach, and shop contexts without mixing permissions.',
    primaryLabel: 'Create account',
    primaryHref: '/register',
    metrics: [
      { label: 'Active workspaces', value: '4', help: 'Personal and organization' },
      { label: 'Pending access', value: '1', help: 'Company verification' },
      { label: 'Security checks', value: 'All clear', help: 'Last review today' },
    ],
    mainTitle: 'Choose a workspace',
    rows: [
    ...
    mobileTitle: 'Workspace switcher',
  }),
  screen({
