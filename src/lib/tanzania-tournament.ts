export const TZ_TOURNAMENT = {
  ...
  prizePoolLabel: 'Announced by Days Esports',
  deadlineLabel: 'Before bracket lock',
  slotsLabel: 'Confirmed after moderator payment review',
  checkInLabel: 'Shared by Days Esports before match time',
  rulesLabel: 'eFootball Mobile bracket. Use the same in-game name and Konami ID submitted on the form.',
  payoutMethodLabel: 'Airtel Money / manual Days Esports payout review',
  currency: 'TSH',
  entryFee: 5000,
