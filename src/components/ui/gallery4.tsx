        ...
        <div className="mb-6 flex items-end justify-between gap-4 md:mb-8 lg:mb-10">
          ...
          <div className="hidden shrink-0 gap-2 md:flex">
            <Button
              ...
              className="h-10 w-10 rounded-full border-[rgba(50,224,196,0.22)] bg-[var(--surface-strong)] text-[var(--text-primary)] hover:border-[rgba(50,224,196,0.36)] hover:bg-[var(--accent-secondary-soft)] disabled:opacity-40 disabled:cursor-not-allowed"
            >
