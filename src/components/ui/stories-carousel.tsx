...
export const Story = ({ className, itemClassName, ...props }: StoryProps) => (
  <CarouselItem className={cn('basis-auto !w-[220px] pl-2 md:pl-4', itemClassName)}>
    <div
      className={cn(
        'group relative w-full overflow-hidden rounded-[var(--radius-panel)] bg-muted/40',
